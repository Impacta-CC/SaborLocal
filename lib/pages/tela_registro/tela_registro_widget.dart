...
import 'tela_registro_model.dart';
export 'tela_registro_model.dart';

class TelaRegistroWidget extends StatefulWidget {
  const TelaRegistroWidget({super.key});

  static String routeName = 'TelaRegistro';
  static String routePath = '/telaRegistro';

  @override
  State<TelaRegistroWidget> createState() => _TelaRegistroWidgetState();
}

class _TelaRegistroWidgetState extends State<TelaRegistroWidget> {
  late TelaRegistroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaRegistroModel());
    ...
    _model.txtConfirmeTextController ??= TextEditingController();
    _model.txtConfirmeFocusNode ??= FocusNode();
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Align(
                                  alignment: AlignmentDirectional(0.0, 0.0),
                                  child: Text(
                                    '\"Um e-mail será enviado com código de confirmação\"',
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.txtConfirmeFocusNode,
                                    autofocus: false,
                                    enabled: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    enableInteractiveSelection: true,
                                    validator: _model
                                        .txtConfirmeTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Align(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: PinCodeTextField(
                                    ...
                                    backgroundColor: Color(0xFF332018),
                                    pinTheme: PinTheme(
                                      fieldHeight: 55.0,
                                      fieldWidth: 45.0,
                                      borderWidth: 2.0,
